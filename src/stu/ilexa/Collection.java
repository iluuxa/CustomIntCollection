...
public class Collection {
     ...
     * @param ind индекс коллекции. Должно быть передано число больше или равное нулю, но не превышающее размер коллекции
    ...
    /**
     * Метод возврата коллекции в удобном для отображения построковом виде
